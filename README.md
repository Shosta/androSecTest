...
1. On Mac 🍏 - Run the Docker Container
    ...
    5.4 Your android device has to be connected wirelessly with your Mac computer in order to make it work within the container (*as Mac OS doesn't have a folder to share the USB device)*.

### 👏 Well done, you are good to go.

Get into your Docker Container, fire the androSecTest app, connect your device and start assessing the security of your Android application. 👨‍💻
